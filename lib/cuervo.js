...
Cuervo.prototype = {
    ...
    printCuervo : function() {
        var cuervoString = [
            '------------------------------------------------------',
            ' e88~~\\ 888  888  e88~~8e  888-~\\ Y88b    /  e88~-_  ', 
            'd888    888  888 d888  88b 888     Y88b  /  d888   i ', 
            '8888    888  888 8888__888 888      Y88b/   8888   | ',
            'Y888    888  888 Y888    , 888       Y8/    Y888   \' ',
            ' "88__/ "88_-888  "88___/  888        Y      "88_-~ ',
            '------------------------------------------------------'
        ]; 
        console.log("              -==Thanks for using==-");
        console.log(cuervoString.join("\n"));
    },
    printDone : function() {
        var me = this,
            newTime = Date.now(),
