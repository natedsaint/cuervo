...
Cuervo.prototype = {
    ...
    generate : function() {
        ...
        me.latestPosts = me.posts.slice(0);
        me.ctx = {
            site: {
                posts: me.posts,
                latestPosts: me.latestPosts.splice(0,me.config.latestNewsCount),
        ...
        me.posts.forEach(function(post,idx) {
            ...
            post.firstPost = me.posts[me.posts.length-1].url;
            post.lastPost = me.posts[0].url;
            ...
            postContent = Mustache.render(me.getLayout(post.layout || "post.mustache",me.ctx),post,me.ctx.partials);
        ...
        me.walkDir("./",me.posts,me.categorizedPosts,me.ctx,me.config);
    },
    walkDir : function(dir,posts,categorizedPosts,ctx,config) {
        ...
        fs.readdirSync(dir).forEach(function(fname) {
            ...
            if (fs.statSync(file).isDirectory()) { // found directory, recursively crawl it!
                me.walkDir(file + "/",posts,categorizedPosts,ctx,config);
            } else {
                var out = "_site/" + file,
                    pageContent;
